...
var ValidationError = require('loopback-model/lib/validations').ValidationError;
var Relation = require('loopback-model/lib/relations');
var Inclusion = require('loopback-model/lib/include');
var List = require('loopback-model').List;
...
var defineScope = require('loopback-model/lib/scope').defineScope;
