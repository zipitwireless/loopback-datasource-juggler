...
/*!
 * Check if the data source is connected. Defer the method invocation if the
 * data source is not connected.
 * Returns a Boolean value.
 * @param {Object} obj The receiver
 * @param {Object} args The arguments
 */
DataSource.prototype.deferInvocation = function (obj, method, args) {
  var self = this;
  if (this.connected) {
    // Connected
    return false;
